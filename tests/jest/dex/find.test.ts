  ...
  const invalidFlagsTestCases = (tag: Tag) => [
    {
      ...
      results: "throws InvalidDexQueryFlagsError: (Chain | First) is an invalid set of flags",
        throws: new InvalidDexQueryFlagsError([FLAGS.CHAIN, FLAGS.FIRST])
    },
    {
      ...
      throws: new InvalidDexQueryFlagsError([FLAGS.CHAIN, FLAGS.FIRST, FLAGS.OR])
    },
    {
      ...
      throws: new InvalidDexQueryFlagsError([FLAGS.CHAIN, FLAGS.FIRST, FLAGS.OR, FLAGS.NOT])
    },
  ]

  const emptyTagTestCases = (tag: Tag, tagType: string = "Empty Tag"): TestCase[] => [
    {
      params: [`["Tag"]`],
      args: [[tag]],
      expected: [],
    ...
    },
    {
      ...
      expected: [entry, entry2, entry3, entry4, entry5],
      results: `All Entries In a Dex from Not and Or of ${tagType} via Chain`,
      instanceof: Dex
    },
    {
